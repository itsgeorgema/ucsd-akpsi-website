...
export default function Footer({ className = "" }: FooterProps) {
  const socialLinks = [
    {
      name: 'Instagram',
      href: 'https://www.instagram.com/akpsi_ucsd/',
      icon: (
    ...
    {
      name: 'LinkedIn',
      href: 'https://www.linkedin.com/company/akpsi-ucsd/',
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: 'Facebook',
      href: 'https://www.facebook.com/akpsiucsd/',
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className="flex items-center space-x-6">
              {socialLinks.map((social) => (
                <a 
                  ...
                  className={akpsiColors.footerIcon + " transition-colors"}
