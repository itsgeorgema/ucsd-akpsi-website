...
import { getCompanyImages, getAboutImages } from "../../utils/imageUtils";
...
const companies = getCompanyImages();
...
export default function About() {
  ...
  const pageContent = {
    ...
    akpsiInfo: {
      ...
      foundingText:
        'Founded on October 5, 1904, at New York University, Alpha Kappa Psi is the world\'s oldest and largest business fraternity. AKPsi was founded by "Brooklyn Four" --- George L. Bergen, Howard M. Jefferson, Nathan Lane Jr., and Frederic R. Leach --- with the purpose of developing its members into principled business leaders.',
    ...
    nuXiInfo: {
      ...
      professionalText:
        "Located in the sunny town of La Jolla, the Nu Xi (NΞ) Chapter brings the values of Alpha Kappa Psi to the UC San Diego campus. Established in 2019, the chapter has grown its presence on-campus and is continuing to develop an extensive alumni network in numerous different industries.",
      communityTitle: "BROTHERHOOD & COMMUNITY",
      communityText:
        "Beyond the professionalism, our Brothers are able to create lifelong friendships and find a community away from home. Alpha Kappa Psi welcomes individuals from all backgrounds and embraces the diverse student population. Our Brothers inspire and help each other pursue our greatest dreams.",
    },
    statistics: {
      ...
      genderDescription:
        "Our chapter maintains a diverse gender representation, fostering an inclusive environment where all members can thrive and contribute their unique perspectives to our professional community.",
      gradeLevelDescription:
        "With members across all academic levels, our chapter provides mentorship opportunities and peer support throughout the entire university journey.",
    },
    contact: {
      title: "CONTACT NU XI",
      subtitle:
  ...
  const openStatModal = (type: "gender" | "grade") => {
    const modalData: StatModalData = {
      ...
      description:
        type === "gender"
          ? pageContent.statistics.genderDescription
          : pageContent.statistics.gradeLevelDescription,
    };
        ...
        content = (
          <div>
            <div className="text-center mb-12">
              <h2
                className={`text-4xl mb-6 ${colors.section.title} ${fontCombinations.section.main}`}
              >
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-8 w-full max-w-full mx-auto justify-items-center">
              ...
              <div className="bg-gradient-to-br from-[#F8F8F8] to-[#B3CDE0]/10 backdrop-blur-sm rounded-2xl p-8 shadow-lg border border-[#D4AF37]/20 hover:border-[#B89334]/40  transition-all duration-300 group w-full max-w-full mx-auto text-center">
                <div className="flex items-center mb-6 w-full max-w-full">
                  <div className="w-14 h-14 aspect-square rounded-full flex items-center justify-center bg-gradient-to-br from-[#003366] to-[#6497B1] mr-4 shadow-lg group-hover:shadow-xl transition-all duration-300">
                    <span
                      className={`text-[#F8F8F8] text-sm ${fontCombinations.technical.label}`}
                    >
                      1904
                    </span>
                  </div>
                  <h3
                    className={`text-2xl bg-gradient-to-r from-[#003366] to-[#6497B1] bg-clip-text text-transparent ${fontCombinations.section.secondary} break-words`}
                  >
                    {pageContent.akpsiInfo.foundingTitle}
                  </h3>
                </div>
                <p
                  className={`text-left relative pl-4 border-l-2 border-[#D4AF37]/30 ${colors.section.text} ${fontCombinations.content.body} break-words`}
                >
              ...
              <div className="bg-gradient-to-br from-[#F8F8F8] to-[#D4AF37]/10 backdrop-blur-sm rounded-2xl p-8 shadow-lg border border-[#D4AF37]/20 hover:border-[#B89334]/40 transition-all duration-300 group w-full max-w-full mx-auto text-center">
                <div className="flex items-center mb-6 w-full max-w-full">
                  ...
                  <h3
                    className={`text-2xl ${colors.section.title} ${fontCombinations.section.secondary} break-words`}
                  >
                    {pageContent.akpsiInfo.networkTitle}
                  </h3>
                </div>
                <p
                  className={`text-left relative pl-4 border-l-2 border-[#003366]/30 ${colors.section.text} ${fontCombinations.content.body} break-words`}
                >
            ...
            <div className="relative rounded-2xl overflow-hidden shadow-lg w-full max-w-full mx-auto">
              <div className="relative w-full h-64">
                <Image
                  src={images.groupPhoto1}
                  alt="Group Photo About Page"
                  fill
      ...
      case "nuxi":
        content = (
          <div>
            <div className="text-center mb-12">
              <h2
                className={`text-4xl mb-4 ${colors.section.title} ${fontCombinations.section.main}`}
              >
                {pageContent.nuXiInfo.title}
              </h2>
              <h3
                className={`text-xl mb-6 ${colors.section.subtitle} ${fontCombinations.section.tertiary}`}
              >
              ...
              <div className="space-y-6 w-full max-w-full mx-auto">
                ...
                <div className="bg-gradient-to-br from-[#F8F8F8] to-[#B3CDE0]/10 backdrop-blur-sm rounded-2xl p-8 shadow-lg border border-[#D4AF37]/20 hover:border-[#B89334]/40 w-full max-w-full mx-auto box-border text-center">
                  <div className="flex items-center mb-4 w-full max-w-full">
                    ...
                    <h3
                      className={`text-xl ${colors.section.title} ${fontCombinations.section.tertiary} break-words`}
                    >
                      {pageContent.nuXiInfo.professionalTitle}
                    </h3>
                  </div>
                  <p
                    className={`text-left ${colors.section.text} ${fontCombinations.content.body} break-words`}
                  >
          ...
          <div>
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-8 w-full max-w-full mx-auto justify-items-center">
              ...
              <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-lg text-center border border-[#D4AF37]/20 hover:border-[#B89334]/40 w-full max-w-full mx-auto box-border text-center">
                <h3
                  className={`text-2xl mb-6 ${colors.section.title} ${fontCombinations.section.secondary}`}
                >
                  {pageContent.statistics.genderTitle}
                </h3>
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-lg border border-[#D4AF37]/20 hover:border-[#B89334]/40 w-full max-w-full mx-auto box-border text-center">
              <h3
                className={`text-2xl text-center mb-8 ${colors.section.title} ${fontCombinations.section.secondary}`}
              >
                INDUSTRY DISTRIBUTION
              </h3>
              <div className="flex flex-col lg:flex-row items-center justify-center gap-8">
                ...
                <div className="grid grid-cols-1 gap-3">
                  {[
                    ...
                    >
                      <div
                        className="w-4 h-4 rounded-full mr-3 aspect-square justify-center items-center"
                        style={{ backgroundColor: industry.color }}
                      ></div>
                      <span
                        className={`text-sm ${colors.section.title} ${fontCombinations.technical.label} block text-left`}
                      >
                        {industry.label}
                      </span>
                    </div>
      ...
      <div className="relative">
        ...
        <div className="relative z-20 min-h-screen flex flex-col about-page">
          ...
          <section className="relative flex flex-col items-center justify-center text-center z-10 min-h-screen">
            ...
            <div className="relative z-10 flex flex-col items-center">
              ...
              <h1
                className={`text-5xl md:text-7xl mb-6 drop-shadow-2xl ${colors.text.inverse} ${akpsiFonts.heroTitleFont}`}
              >
                {pageContent.hero.title}
              </h1>
              <p
                className={`text-xl md:text-2xl mb-12 drop-shadow-lg max-w-3xl mx-auto ${colors.glass.textSubtle} ${akpsiFonts.sectionTextFont}`}
              >
          ...
          >
            ...
            <div
              className={`absolute inset-0 bg-white/85 backdrop-blur-lg rounded-3xl border border-[#B3CDE0]/30 shadow-2xl`}
            ></div>
                    ...
                    {["akpsi", "nuxi", "statistics"].map((tab, index) => {
                      ...
                      return (
                        <button
                          ...
                          className={`transition-all duration-500 md:rounded-t-2xl
                          ...
                          style={{
                            ...
                            marginBottom: "0px",
                            transition:
                              "flex-grow 0.5s cubic-bezier(0.4,0,0.2,1), background 0.3s, color 0.3s",
                            boxShadow: "none",
                          }}
                        >
                              ...
                              {tab === "statistics" && (
                                ...
                                >
                                  <path
                                    strokeLinecap="round"
                                    strokeLinejoin="round"
                                    d="M4 18v-4M8 18v-8M12 18v-6M16 18v-10M20 18v-2"
                                  />
                                </svg>
                              )}
                            </div>
                            <span
                              className={`text-base ${fontCombinations.navigation.primary}`}
                            >
                ...
                >
                  <div className="w-full bg-white/95 backdrop-blur-md rounded-3xl shadow-2xl p-8 lg:p-12 mt-8">
                    <div className="text-center mb-12">
                      ...
                      <p
                        className={`text-lg max-w-3xl mx-auto ${colors.section.text} ${fontCombinations.content.lead}`}
                      >
                        Our brothers have secured positions at leading companies
              ...
              <div className="max-w-4xl mx-auto px-4">
                <div className="w-full max-w-full bg-white/95 backdrop-blur-md rounded-3xl shadow-2xl p-8 lg:p-12 text-center">
                  <div className="mb-8">
                    ...
                    <p
                      className={`text-lg max-w-2xl mx-auto ${colors.section.text} ${fontCombinations.content.lead}`}
                    >
        ...
        {selectedStat && (
          <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
            <div
              className={`${colors.section.bg} rounded-lg shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-auto transition-transform duration-300`}
            >
              <div className="p-8 relative">
                ...
                <div className="flex justify-between items-center mb-6">
                  <h3
                    className={`text-3xl ${colors.section.title} ${fontCombinations.section.main}`}
                  >
                    {selectedStat.title}
                  </h3>
                </div>
                ...
                <p
                  className={`text-lg ${colors.section.text} ${fontCombinations.content.lead}`}
                >
