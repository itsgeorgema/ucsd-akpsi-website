...
export default function Contact() {
  ...
  const triggerScrollToTop = () => {
    window.dispatchEvent(new Event("akpsi-scroll-to-top"));
  };
          ...
          >
            <div className="max-w-6xl w-full bg-white/10 backdrop-blur-md rounded-2xl border border-white/20 shadow-2xl overflow-hidden">
              <div className="p-8 lg:p-12">
                <div className="mb-8">
                  <h2
                    className={`text-3xl font-bold mb-8 text-center md:text-left ${colors.glass.text} ${fontCombinations.section.main}`}
                  >
                    Contact Us
                  </h2>
                </div>
