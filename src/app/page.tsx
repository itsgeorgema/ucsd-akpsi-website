        ...
        {loading ? (
          ...
          <>
            ...
            <section className="relative flex flex-col justify-center h-screen px-4 md:px-8 lg:px-12">
              <div className="relative z-10 max-w-7xl mx-auto w-full pt-8 md:pt-12 lg:pt-16">
                {/* Title Section - Fixed Height Container */}
                <div className="h-48 md:h-64 lg:h-80 mb-20 md:mb-24 flex items-end overflow-hidden">
                  <h1 className={`text-4xl md:text-6xl lg:text-7xl xl:text-8xl ${colors.heroTitle} leading-none ${fontCombinations.hero.title} w-full`}>
                    <AnimatedTitle />
                  </h1>
                </div>

                {/* Values Section - Isolated from Title Animation */}
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 xl:grid-cols-5 gap-4 md:gap-6 lg:gap-8 mb-6 md:mb-8">
                  {/* Brotherhood */}
                  <BouncyFadeIn delay={0.1} threshold={0.1}>
                    <div className={`${colors.glass.text}`}>
                      ...
                      <h3 className={`text-sm md:text-base lg:text-lg mb-1 md:mb-2 ${colors.glass.text} ${fontCombinations.values.title}`}>BROTHERHOOD</h3>
                      <p className={`text-xs md:text-sm ${colors.glass.textBody} ${fontCombinations.values.description}`}>We are a family of life-long friends that stick together through thick and thin.</p>
                    </div>
                  </BouncyFadeIn>
                  ...
                  <BouncyFadeIn delay={0.2} threshold={0.1}>
                    <div className={`${colors.glass.text}`}>
                      ...
                      <h3 className={`text-sm md:text-base lg:text-lg mb-1 md:mb-2 ${colors.glass.text} ${fontCombinations.values.title}`}>INTEGRITY</h3>
                      <p className={`text-xs md:text-sm ${colors.glass.textBody} ${fontCombinations.values.description}`}>We do things through hard work and dedication, while not taking any unnecessary shortcuts.</p>
                    </div>
                  </BouncyFadeIn>
                  ...
                  <BouncyFadeIn delay={0.3} threshold={0.1}>
                    <div className={`${colors.glass.text}`}>
                      ...
                      <h3 className={`text-sm md:text-base lg:text-lg mb-1 md:mb-2 ${colors.glass.text} ${fontCombinations.values.title}`}>SERVICE</h3>
                      <p className={`text-xs md:text-sm ${colors.glass.textBody} ${fontCombinations.values.description}`}>We believe in giving back to the communities that have shaped us into the people we are today.</p>
                    </div>
                  </BouncyFadeIn>
                  ...
                  <BouncyFadeIn delay={0.4} threshold={0.1}>
                    <div className={`${colors.glass.text}`}>
                      ...
                      <h3 className={`text-sm md:text-base lg:text-lg mb-1 md:mb-2 ${colors.glass.text} ${fontCombinations.values.title}`}>UNITY</h3>
                      <p className={`text-xs md:text-sm ${colors.glass.textBody} ${fontCombinations.values.description}`}>We strive to build our bonds and strengthen the brotherhood that we are proud of.</p>
                    </div>
                  </BouncyFadeIn>
                  ...
                  <BouncyFadeIn delay={0.5} threshold={0.1}>
                    <div className={`${colors.glass.text}`}>
                      ...
                      <h3 className={`text-sm md:text-base lg:text-lg mb-1 md:mb-2 ${colors.glass.text} ${fontCombinations.values.title}`}>KNOWLEDGE</h3>
                      <p className={`text-xs md:text-sm ${colors.glass.textBody} ${fontCombinations.values.description}`}>We are scholars of diverse disciplines and professionals in varied industries.</p>
                    </div>
                  </BouncyFadeIn>
                </div>
                ...
                <BouncyFadeIn delay={0.1} threshold={0.1} bounce={0}>
                  <div className="flex-1 max-w-4xl w-full lg:pr-12 relative z-10">
                    ...
                    <div className="space-y-4 md:space-y-6">
                      <p className={`text-base md:text-lg relative pl-4 border-l-4 border-[#D4AF37] ${colors.section.text} ${fontCombinations.content.lead}`}>Welcome! This is the website for the Nu Xi Chapter of Alpha Kappa Psi. Here, you can explore our values, who our brothers are, and how you can get involved. Before diving into the details, the brothers of the Nu Xi Chapter would like to thank you for your interest in our fraternity.</p>
                ...
                <BouncyFadeIn delay={0.1} threshold={0.1} bounce={0}>
                  <div className="flex-1 flex justify-center lg:justify-end items-center w-full max-w-xl mt-8 lg:mt-0">
                    {president ? (
                      ...
                      <div className={`w-full max-w-sm md:max-w-md lg:max-w-lg h-64 md:h-80 bg-gradient-to-br from-[#B3CDE0]/20 to-[#D4AF37]/10 rounded-2xl flex items-center justify-center border border-[#B3CDE0]/30 shadow-lg backdrop-blur-sm relative overflow-hidden`}>
