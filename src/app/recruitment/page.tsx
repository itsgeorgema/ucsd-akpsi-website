    ...
    <div className="relative min-h-screen flex flex-col">
      ...
      <div className="relative z-20 min-h-screen flex flex-col">
        ...
        <main className="flex-1 flex items-center justify-center py-16 px-4 mt-20">
          <div className="bg-white rounded-2xl shadow-2xl p-10 max-w-6xl w-full mx-auto">
            {/* ABOUT RECRUITMENT Section */}
            <div className="grid lg:grid-cols-2 gap-12 mb-12">
              {/* Left Side - About Content */}
              <div className="space-y-6">
                <h2 className={`text-4xl font-bold ${akpsiColors.sectionTitle} ${akpsiFonts.sectionTitleFont}`}>
                  ABOUT RECRUITMENT
                </h2>
                ...
                <p className={`text-lg font-semibold ${akpsiColors.sectionText} ${akpsiFonts.bodyFont}`}>
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  <a 
                    ...
                    className={`px-8 py-3 ${akpsiColors.contactButton} ${akpsiColors.contactButtonHover} font-semibold rounded-lg transition-colors ${akpsiFonts.sectionTextFont} text-center ${!links.interestForm ? 'opacity-50 cursor-not-allowed' : ''}`}
                    onClick={(e) => {
                  ...
                  <a 
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className={`px-8 py-3 ${akpsiColors.contactButton} ${akpsiColors.contactButtonHover} font-semibold rounded-lg transition-colors ${akpsiFonts.sectionTextFont} text-center ${!links.applicationWebsite ? 'opacity-50 cursor-not-allowed' : ''}`}
              ...
              <div className="rounded-xl overflow-hidden">
                {flyerImage ? (
                  ...
                  <div className={`${akpsiColors.statCircleBg} rounded-xl p-6 flex items-center justify-center h-64`}>
                    <div className={`text-center ${akpsiColors.statCircleText}`}>
                      <p className="text-lg mb-2">Loading flyer...</p>
                      <p className="text-sm">spring25RushFlyer.jpg</p>
                    </div>
                  </div>
                )}
              </div>
            ...
            <div className="mb-12">
              <h2 className={`text-4xl font-bold mb-8 text-center ${akpsiColors.sectionTitle} ${akpsiFonts.sectionTitleFont}`}>
                RUSH WEEK SCHEDULE
              </h2>
              <div className="space-y-6">
                {/* INFO NIGHT */}
                <div className={`${akpsiColors.mainBg} rounded-lg p-6`}>
                  <h3 className={`text-xl font-bold mb-2 ${akpsiColors.sectionTitle} ${akpsiFonts.sectionTitleFont}`}>INFO NIGHT</h3>
                  <p className={`${akpsiColors.sectionSubtitle} font-semibold mb-2 ${akpsiFonts.sectionTextFont}`}>MONDAY, 4/07 @ 6:00 PM</p>
                  <p className={`${akpsiColors.sectionSubtitle} font-semibold mb-2 ${akpsiFonts.sectionTextFont}`}>Price Center Theater | Casual Attire</p>
                ...
                {/* BUSINESS WORKSHOP */}
                <div className={`${akpsiColors.mainBg} rounded-lg p-6`}>
                  <h3 className={`text-xl font-bold mb-2 ${akpsiColors.sectionTitle} ${akpsiFonts.sectionTitleFont}`}>BUSINESS WORKSHOP</h3>
                  <p className={`${akpsiColors.sectionSubtitle} font-semibold mb-2 ${akpsiFonts.sectionTextFont}`}>TUESDAY, 4/08 @ 8:00 PM</p>
                  <p className={`${akpsiColors.sectionSubtitle} font-semibold mb-2 ${akpsiFonts.sectionTextFont}`}>Price Center-Ballroom West B | Business Casual Attire</p>
                ...
                {/* CASE STUDY NIGHT */}
                <div className={`${akpsiColors.mainBg} rounded-lg p-6`}>
                  <h3 className={`text-xl font-bold mb-2 ${akpsiColors.sectionTitle} ${akpsiFonts.sectionTitleFont}`}>CASE STUDY NIGHT</h3>
                  <p className={`${akpsiColors.sectionSubtitle} font-semibold mb-2 ${akpsiFonts.sectionTextFont}`}>WEDNESDAY, 4/09 | *BY APPOINTMENT ONLY</p>
                  <p className={`${akpsiColors.sectionSubtitle} font-semibold mb-2 ${akpsiFonts.sectionTextFont}`}>TBA | Professional Attire</p>
                ...
                {/* SOCIAL MIXER */}
                <div className={`${akpsiColors.mainBg} rounded-lg p-6`}>
                  <h3 className={`text-xl font-bold mb-2 ${akpsiColors.sectionTitle} ${akpsiFonts.sectionTitleFont}`}>SOCIAL MIXER</h3>
                  <p className={`${akpsiColors.sectionSubtitle} font-semibold mb-2 ${akpsiFonts.sectionTextFont}`}>FRIDAY, 4/11 | *INVITE ONLY</p>
                  <p className={`${akpsiColors.sectionSubtitle} font-semibold mb-2 ${akpsiFonts.sectionTextFont}`}>TBA | Casual Attire</p>
                ...
                {/* INTERVIEWS */}
                <div className={`${akpsiColors.mainBg} rounded-lg p-6`}>
                  <h3 className={`text-xl font-bold mb-2 ${akpsiColors.sectionTitle} ${akpsiFonts.sectionTitleFont}`}>INTERVIEWS</h3>
                  <p className={`${akpsiColors.sectionSubtitle} font-semibold mb-2 ${akpsiFonts.sectionTextFont}`}>SATURDAY, 4/12 | *BY APPOINTMENT ONLY</p>
                  <p className={`${akpsiColors.sectionSubtitle} font-semibold mb-2 ${akpsiFonts.sectionTextFont}`}>TBA | Professional Attire</p>
              ...
              <div className="text-center mt-8">
                <a 
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className={`px-8 py-3 ${akpsiColors.contactButton} ${akpsiColors.contactButtonHover} font-semibold rounded-lg transition-colors ${akpsiFonts.sectionTextFont} inline-block ${!links.instagram ? 'opacity-50 cursor-not-allowed' : ''}`}
            ...
            <div className="text-center">
              ...
              <div className={`${akpsiColors.mainBg} rounded-lg p-8`}>
                <h3 className={`text-xl font-bold mb-4 ${akpsiColors.sectionTitle} ${akpsiFonts.sectionTitleFont}`}>Rush Chairs</h3>
            ...
            {galleryImages.length > 0 && (
              <div className="mt-12">
                <div className="relative">
                  <div className="flex gap-4 overflow-hidden gallery-container">
                  ...
                  {/* Left Arrow */}
                  <button 
                    className="absolute left-0 top-1/2 transform -translate-y-1/2 -translate-x-4 bg-white/80 hover:bg-white text-gray-800 rounded-full p-2 shadow-lg transition-all duration-200"
                    onClick={() => {
                      const container = document.querySelector('.gallery-container');
                      if (container) {
                        container.scrollLeft -= 280; // 256px image + 16px gap
                        
                        // If we're at the beginning of the first set, jump to the end of the first set
                        if (container.scrollLeft <= 0) {
                          setTimeout(() => {
                            container.scrollLeft = (galleryImages.length * 280) - 280;
                          }, 300);
                        }
                      }
                    }}
                  ...
                  {/* Right Arrow */}
                  <button 
                    className="absolute right-0 top-1/2 transform -translate-y-1/2 translate-x-4 bg-white/80 hover:bg-white text-gray-800 rounded-full p-2 shadow-lg transition-all duration-200"
                    onClick={() => {
                      const container = document.querySelector('.gallery-container');
                      if (container) {
                        container.scrollLeft += 280; // 256px image + 16px gap
                        ...
                        if (container.scrollLeft >= (galleryImages.length * 280) - 280) {
                          setTimeout(() => {
